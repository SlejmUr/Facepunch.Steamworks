...
namespace Steamworks
{
	...
	// ESteamHardwareType
	//
	internal enum SteamHardwareType : int
	{
		None = 0,
		SteamDeck = 1,
		SteamMachine = 2,
	...
	//
	internal enum SteamHardwareDefaultConfig : int
	{
		None = 0,
		Low = 1,
		Medium = 2,
	...
	//
	// EGamePerformanceSetting
	//
	internal enum GamePerformanceSetting : int
	{
		NotSet = 0,
		Low = 1,
		Medium = 2,
	...
	internal enum HTTPStatusCode : int
	{
		...
		Code451UnavailableForLegalReasons = 451,
	...
	internal enum InputActionOrigin : int
	{
		...
		Switch2_X = 497,
		Switch2_Y = 498,
		Switch2_LeftBumper = 499,
		Switch2_RightBumper = 500,
		Switch2_Plus = 501,
		Switch2_Minus = 502,
		Switch2_Capture = 503,
		Switch2_LeftTrigger_Pull = 504,
		Switch2_LeftTrigger_Click = 505,
		Switch2_RightTrigger_Pull = 506,
		Switch2_RightTrigger_Click = 507,
		Switch2_LeftStick_Move = 508,
		Switch2_LeftStick_Click = 509,
		Switch2_LeftStick_DPadNorth = 510,
		Switch2_LeftStick_DPadSouth = 511,
		Switch2_LeftStick_DPadWest = 512,
		Switch2_LeftStick_DPadEast = 513,
		Switch2_RightStick_Move = 514,
		Switch2_RightStick_Click = 515,
		Switch2_RightStick_DPadNorth = 516,
		Switch2_RightStick_DPadSouth = 517,
		Switch2_RightStick_DPadWest = 518,
		Switch2_RightStick_DPadEast = 519,
		Switch2_DPad_Move = 520,
		Switch2_DPad_North = 521,
		Switch2_DPad_South = 522,
		Switch2_DPad_West = 523,
		Switch2_DPad_East = 524,
		Switch2_ProGyro_Move = 525,
		Switch2_ProGyro_Pitch = 526,
		Switch2_ProGyro_Yaw = 527,
		Switch2_ProGyro_Roll = 528,
		Switch2_GL = 529,
		Switch2_GR = 530,
		Switch2_C = 531,
		Switch2_Reserved1 = 532,
		Switch2_Reserved2 = 533,
		Switch2_Reserved3 = 534,
		Switch2_Reserved4 = 535,
		Switch2_Reserved5 = 536,
		Switch2_Reserved6 = 537,
		Switch2_Reserved7 = 538,
		Switch2_Reserved8 = 539,
		Switch2_Reserved9 = 540,
		Switch2_Reserved10 = 541,
		SteamController2026_A = 542,
		SteamController2026_B = 543,
		SteamController2026_X = 544,
		SteamController2026_Y = 545,
		SteamController2026_L1 = 546,
		SteamController2026_R1 = 547,
		SteamController2026_Menu = 548,
		SteamController2026_View = 549,
		SteamController2026_LeftPad_Touch = 550,
		SteamController2026_LeftPad_Swipe = 551,
		SteamController2026_LeftPad_Click = 552,
		SteamController2026_LeftPad_DPadNorth = 553,
		SteamController2026_LeftPad_DPadSouth = 554,
		SteamController2026_LeftPad_DPadWest = 555,
		SteamController2026_LeftPad_DPadEast = 556,
		SteamController2026_RightPad_Touch = 557,
		SteamController2026_RightPad_Swipe = 558,
		SteamController2026_RightPad_Click = 559,
		SteamController2026_RightPad_DPadNorth = 560,
		SteamController2026_RightPad_DPadSouth = 561,
		SteamController2026_RightPad_DPadWest = 562,
		SteamController2026_RightPad_DPadEast = 563,
		SteamController2026_L2_SoftPull = 564,
		SteamController2026_L2 = 565,
		SteamController2026_R2_SoftPull = 566,
		SteamController2026_R2 = 567,
		SteamController2026_LeftStick_Move = 568,
		SteamController2026_L3 = 569,
		SteamController2026_LeftStick_DPadNorth = 570,
		SteamController2026_LeftStick_DPadSouth = 571,
		SteamController2026_LeftStick_DPadWest = 572,
		SteamController2026_LeftStick_DPadEast = 573,
		SteamController2026_LeftStick_Touch = 574,
		SteamController2026_RightStick_Move = 575,
		SteamController2026_R3 = 576,
		SteamController2026_RightStick_DPadNorth = 577,
		SteamController2026_RightStick_DPadSouth = 578,
		SteamController2026_RightStick_DPadWest = 579,
		SteamController2026_RightStick_DPadEast = 580,
		SteamController2026_RightStick_Touch = 581,
		SteamController2026_L4 = 582,
		SteamController2026_R4 = 583,
		SteamController2026_L5 = 584,
		SteamController2026_R5 = 585,
		SteamController2026_DPad_Move = 586,
		SteamController2026_DPad_North = 587,
		SteamController2026_DPad_South = 588,
		SteamController2026_DPad_West = 589,
		SteamController2026_DPad_East = 590,
		SteamController2026_Gyro_Move = 591,
		SteamController2026_Gyro_Pitch = 592,
		SteamController2026_Gyro_Yaw = 593,
		SteamController2026_Gyro_Roll = 594,
		SteamController2026_LGrip = 595,
		SteamController2026_RGrip = 596,
		SteamController2026_Reserved1 = 597,
		SteamController2026_Reserved2 = 598,
		SteamController2026_Reserved3 = 599,
		SteamController2026_Reserved4 = 600,
		SteamController2026_Reserved5 = 601,
		SteamController2026_Reserved6 = 602,
		SteamController2026_Reserved7 = 603,
		SteamController2026_Reserved8 = 604,
		SteamController2026_Reserved9 = 605,
		SteamController2026_Reserved10 = 606,
		SteamController2026_Reserved11 = 607,
		SteamController2026_Reserved12 = 608,
		SteamController2026_Reserved13 = 609,
		SteamController2026_Reserved14 = 610,
		SteamController2026_Reserved15 = 611,
		SteamController2026_Reserved16 = 612,
		SteamController2026_Reserved17 = 613,
		SteamController2026_Reserved18 = 614,
		SteamController2026_Reserved19 = 615,
		SteamController2026_Reserved20 = 616,
		SteamFrameController_A_Click = 617,
		SteamFrameController_A_Touch = 618,
		SteamFrameController_B_Click = 619,
		SteamFrameController_B_Touch = 620,
		SteamFrameController_X_Click = 621,
		SteamFrameController_X_Touch = 622,
		SteamFrameController_Y_Click = 623,
		SteamFrameController_Y_Touch = 624,
		SteamFrameController_LeftTrigger_Pull = 625,
		SteamFrameController_LeftTrigger_Click = 626,
		SteamFrameController_LeftTrigger_Touch = 627,
		SteamFrameController_RightTrigger_Pull = 628,
		SteamFrameController_RightTrigger_Click = 629,
		SteamFrameController_RightTrigger_Touch = 630,
		SteamFrameController_Menu_Click = 631,
		SteamFrameController_Menu_Touch = 632,
		SteamFrameController_View_Click = 633,
		SteamFrameController_View_Touch = 634,
		SteamFrameController_LeftBumper_Click = 635,
		SteamFrameController_LeftBumper_Touch = 636,
		SteamFrameController_RightBumper_Click = 637,
		SteamFrameController_RightBumper_Touch = 638,
		SteamFrameController_LeftStick_Move = 639,
		SteamFrameController_LeftStick_Click = 640,
		SteamFrameController_LeftStick_DPadNorth = 641,
		SteamFrameController_LeftStick_DPadSouth = 642,
		SteamFrameController_LeftStick_DPadWest = 643,
		SteamFrameController_LeftStick_DPadEast = 644,
		SteamFrameController_LeftStick_Touch = 645,
		SteamFrameController_RightStick_Move = 646,
		SteamFrameController_RightStick_Click = 647,
		SteamFrameController_RightStick_DPadNorth = 648,
		SteamFrameController_RightStick_DPadSouth = 649,
		SteamFrameController_RightStick_DPadWest = 650,
		SteamFrameController_RightStick_DPadEast = 651,
		SteamFrameController_RightStick_Touch = 652,
		SteamFrameController_DPad_Move = 653,
		SteamFrameController_DPad_North = 654,
		SteamFrameController_DPad_South = 655,
		SteamFrameController_DPad_West = 656,
		SteamFrameController_DPad_East = 657,
		SteamFrameController_DPad_Touch = 658,
		SteamFrameController_LeftGyro_Move = 659,
		SteamFrameController_LeftGyro_Pitch = 660,
		SteamFrameController_LeftGyro_Yaw = 661,
		SteamFrameController_LeftGyro_Roll = 662,
		SteamFrameController_RightGyro_Move = 663,
		SteamFrameController_RightGyro_Pitch = 664,
		SteamFrameController_RightGyro_Yaw = 665,
		SteamFrameController_RightGyro_Roll = 666,
		SteamFrameController_LeftGrip_Pull = 667,
		SteamFrameController_LeftGrip_Click = 668,
		SteamFrameController_LeftGrip_Touch = 669,
		SteamFrameController_RightGrip_Pull = 670,
		SteamFrameController_RightGrip_Click = 671,
		SteamFrameController_RightGrip_Touch = 672,
		SteamFrameController_LeftThumbrest_Touch = 673,
		SteamFrameController_RightThumbrest_Touch = 674,
		SteamFrameController_Reserved1 = 675,
		SteamFrameController_Reserved2 = 676,
		SteamFrameController_Reserved3 = 677,
		SteamFrameController_Reserved4 = 678,
		SteamFrameController_Reserved5 = 679,
		SteamFrameController_Reserved6 = 680,
		SteamFrameController_Reserved7 = 681,
		SteamFrameController_Reserved8 = 682,
		SteamFrameController_Reserved9 = 683,
		SteamFrameController_Reserved10 = 684,
		SteamFrameController_Reserved11 = 685,
		SteamFrameController_Reserved12 = 686,
		SteamFrameController_Reserved13 = 687,
		SteamFrameController_Reserved14 = 688,
		SteamFrameController_Reserved15 = 689,
		SteamFrameController_Reserved16 = 690,
		SteamFrameController_Reserved17 = 691,
		SteamFrameController_Reserved18 = 692,
		SteamFrameController_Reserved19 = 693,
		SteamFrameController_Reserved20 = 694,
		Count = 695,
	...
	internal enum ControllerActionOrigin : int
	{
		...
		Switch2_X = 477,
		Switch2_Y = 478,
		Switch2_LeftBumper = 479,
		Switch2_RightBumper = 480,
		Switch2_Plus = 481,
		Switch2_Minus = 482,
		Switch2_Capture = 483,
		Switch2_LeftTrigger_Pull = 484,
		Switch2_LeftTrigger_Click = 485,
		Switch2_RightTrigger_Pull = 486,
		Switch2_RightTrigger_Click = 487,
		Switch2_LeftStick_Move = 488,
		Switch2_LeftStick_Click = 489,
		Switch2_LeftStick_DPadNorth = 490,
		Switch2_LeftStick_DPadSouth = 491,
		Switch2_LeftStick_DPadWest = 492,
		Switch2_LeftStick_DPadEast = 493,
		Switch2_RightStick_Move = 494,
		Switch2_RightStick_Click = 495,
		Switch2_RightStick_DPadNorth = 496,
		Switch2_RightStick_DPadSouth = 497,
		Switch2_RightStick_DPadWest = 498,
		Switch2_RightStick_DPadEast = 499,
		Switch2_DPad_Move = 500,
		Switch2_DPad_North = 501,
		Switch2_DPad_South = 502,
		Switch2_DPad_West = 503,
		Switch2_DPad_East = 504,
		Switch2_ProGyro_Move = 505,
		Switch2_ProGyro_Pitch = 506,
		Switch2_ProGyro_Yaw = 507,
		Switch2_ProGyro_Roll = 508,
		Switch2_GL = 509,
		Switch2_GR = 510,
		Switch2_C = 511,
		Switch2_Reserved1 = 512,
		Switch2_Reserved2 = 513,
		Switch2_Reserved3 = 514,
		Switch2_Reserved4 = 515,
		Switch2_Reserved5 = 516,
		Switch2_Reserved6 = 517,
		Switch2_Reserved7 = 518,
		Switch2_Reserved8 = 519,
		Switch2_Reserved9 = 520,
		Switch2_Reserved10 = 521,
		SteamController2026_A = 522,
		SteamController2026_B = 523,
		SteamController2026_X = 524,
		SteamController2026_Y = 525,
		SteamController2026_L1 = 526,
		SteamController2026_R1 = 527,
		SteamController2026_Menu = 528,
		SteamController2026_View = 529,
		SteamController2026_LeftPad_Touch = 530,
		SteamController2026_LeftPad_Swipe = 531,
		SteamController2026_LeftPad_Click = 532,
		SteamController2026_LeftPad_DPadNorth = 533,
		SteamController2026_LeftPad_DPadSouth = 534,
		SteamController2026_LeftPad_DPadWest = 535,
		SteamController2026_LeftPad_DPadEast = 536,
		SteamController2026_RightPad_Touch = 537,
		SteamController2026_RightPad_Swipe = 538,
		SteamController2026_RightPad_Click = 539,
		SteamController2026_RightPad_DPadNorth = 540,
		SteamController2026_RightPad_DPadSouth = 541,
		SteamController2026_RightPad_DPadWest = 542,
		SteamController2026_RightPad_DPadEast = 543,
		SteamController2026_L2_SoftPull = 544,
		SteamController2026_L2 = 545,
		SteamController2026_R2_SoftPull = 546,
		SteamController2026_R2 = 547,
		SteamController2026_LeftStick_Move = 548,
		SteamController2026_L3 = 549,
		SteamController2026_LeftStick_DPadNorth = 550,
		SteamController2026_LeftStick_DPadSouth = 551,
		SteamController2026_LeftStick_DPadWest = 552,
		SteamController2026_LeftStick_DPadEast = 553,
		SteamController2026_LeftStick_Touch = 554,
		SteamController2026_RightStick_Move = 555,
		SteamController2026_R3 = 556,
		SteamController2026_RightStick_DPadNorth = 557,
		SteamController2026_RightStick_DPadSouth = 558,
		SteamController2026_RightStick_DPadWest = 559,
		SteamController2026_RightStick_DPadEast = 560,
		SteamController2026_RightStick_Touch = 561,
		SteamController2026_L4 = 562,
		SteamController2026_R4 = 563,
		SteamController2026_L5 = 564,
		SteamController2026_R5 = 565,
		SteamController2026_DPad_Move = 566,
		SteamController2026_DPad_North = 567,
		SteamController2026_DPad_South = 568,
		SteamController2026_DPad_West = 569,
		SteamController2026_DPad_East = 570,
		SteamController2026_Gyro_Move = 571,
		SteamController2026_Gyro_Pitch = 572,
		SteamController2026_Gyro_Yaw = 573,
		SteamController2026_Gyro_Roll = 574,
		SteamController2026_LGrip = 575,
		SteamController2026_RGrip = 576,
		SteamController2026_Reserved1 = 577,
		SteamController2026_Reserved2 = 578,
		SteamController2026_Reserved3 = 579,
		SteamController2026_Reserved4 = 580,
		SteamController2026_Reserved5 = 581,
		SteamController2026_Reserved6 = 582,
		SteamController2026_Reserved7 = 583,
		SteamController2026_Reserved8 = 584,
		SteamController2026_Reserved9 = 585,
		SteamController2026_Reserved10 = 586,
		SteamController2026_Reserved11 = 587,
		SteamController2026_Reserved12 = 588,
		SteamController2026_Reserved13 = 589,
		SteamController2026_Reserved14 = 590,
		SteamController2026_Reserved15 = 591,
		SteamController2026_Reserved16 = 592,
		SteamController2026_Reserved17 = 593,
		SteamController2026_Reserved18 = 594,
		SteamController2026_Reserved19 = 595,
		SteamController2026_Reserved20 = 596,
		SteamFrameController_A_Click = 597,
		SteamFrameController_A_Touch = 598,
		SteamFrameController_B_Click = 599,
		SteamFrameController_B_Touch = 600,
		SteamFrameController_X_Click = 601,
		SteamFrameController_X_Touch = 602,
		SteamFrameController_Y_Click = 603,
		SteamFrameController_Y_Touch = 604,
		SteamFrameController_LeftTrigger_Pull = 605,
		SteamFrameController_LeftTrigger_Click = 606,
		SteamFrameController_LeftTrigger_Touch = 607,
		SteamFrameController_RightTrigger_Pull = 608,
		SteamFrameController_RightTrigger_Click = 609,
		SteamFrameController_RightTrigger_Touch = 610,
		SteamFrameController_Menu_Click = 611,
		SteamFrameController_Menu_Touch = 612,
		SteamFrameController_View_Click = 613,
		SteamFrameController_View_Touch = 614,
		SteamFrameController_LeftBumper_Click = 615,
		SteamFrameController_LeftBumper_Touch = 616,
		SteamFrameController_RightBumper_Click = 617,
		SteamFrameController_RightBumper_Touch = 618,
		SteamFrameController_LeftStick_Move = 619,
		SteamFrameController_LeftStick_Click = 620,
		SteamFrameController_LeftStick_DPadNorth = 621,
		SteamFrameController_LeftStick_DPadSouth = 622,
		SteamFrameController_LeftStick_DPadWest = 623,
		SteamFrameController_LeftStick_DPadEast = 624,
		SteamFrameController_LeftStick_Touch = 625,
		SteamFrameController_RightStick_Move = 626,
		SteamFrameController_RightStick_Click = 627,
		SteamFrameController_RightStick_DPadNorth = 628,
		SteamFrameController_RightStick_DPadSouth = 629,
		SteamFrameController_RightStick_DPadWest = 630,
		SteamFrameController_RightStick_DPadEast = 631,
		SteamFrameController_RightStick_Touch = 632,
		SteamFrameController_DPad_Move = 633,
		SteamFrameController_DPad_North = 634,
		SteamFrameController_DPad_South = 635,
		SteamFrameController_DPad_West = 636,
		SteamFrameController_DPad_East = 637,
		SteamFrameController_DPad_Touch = 638,
		SteamFrameController_LeftGyro_Move = 639,
		SteamFrameController_LeftGyro_Pitch = 640,
		SteamFrameController_LeftGyro_Yaw = 641,
		SteamFrameController_LeftGyro_Roll = 642,
		SteamFrameController_RightGyro_Move = 643,
		SteamFrameController_RightGyro_Pitch = 644,
		SteamFrameController_RightGyro_Yaw = 645,
		SteamFrameController_RightGyro_Roll = 646,
		SteamFrameController_LeftGrip_Pull = 647,
		SteamFrameController_LeftGrip_Click = 648,
		SteamFrameController_LeftGrip_Touch = 649,
		SteamFrameController_RightGrip_Pull = 650,
		SteamFrameController_RightGrip_Click = 651,
		SteamFrameController_RightGrip_Touch = 652,
		SteamFrameController_LeftThumbrest_Touch = 653,
		SteamFrameController_RightThumbrest_Touch = 654,
		SteamFrameController_Reserved1 = 655,
		SteamFrameController_Reserved2 = 656,
		SteamFrameController_Reserved3 = 657,
		SteamFrameController_Reserved4 = 658,
		SteamFrameController_Reserved5 = 659,
		SteamFrameController_Reserved6 = 660,
		SteamFrameController_Reserved7 = 661,
		SteamFrameController_Reserved8 = 662,
		SteamFrameController_Reserved9 = 663,
		SteamFrameController_Reserved10 = 664,
		SteamFrameController_Reserved11 = 665,
		SteamFrameController_Reserved12 = 666,
		SteamFrameController_Reserved13 = 667,
		SteamFrameController_Reserved14 = 668,
		SteamFrameController_Reserved15 = 669,
		SteamFrameController_Reserved16 = 670,
		SteamFrameController_Reserved17 = 671,
		SteamFrameController_Reserved18 = 672,
		SteamFrameController_Reserved19 = 673,
		SteamFrameController_Reserved20 = 674,
		Count = 675,
		MaximumPossibleValue = 32767,
	}
